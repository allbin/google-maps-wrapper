...
/// <reference path="google_maps_wrapper.d.ts" />
namespace GoogleMapsWrapper {
  ...
  export const WrappedMapBase: React.FunctionComponent<MapBaseProps> = ({
    ...
    useEffect(() => {
      ...
      return () => {
        ...
        this.script_cache.google.onLoad(() => {
          ...
          setMap(maps.Map(this.html_element, mapConfig));
    ...
    const setPolygon = (
      ...
      internal_helpers.setPolygon(this, id, options);
    ...
    const registerDragStartCB = (cb: () => void) =>
      this.do_on_drag_end.push(cb);
    ...
    const setDrawingMode = (
      ...
      if (
        this.services.drawing.OverlayType.hasOwnProperty(type.toUpperCase())
      ) {
    ...
    const cuttingPositionUpdate = (mouse_event: MouseEvent) => {
    ...
    const cuttingClick = (mouse_event: google.maps.MouseEvent): void => {
      if (!this.cutting.id) {
...
export default GoogleMapsWrapper.WrappedMapBase;
