...
import { GMW_LatLngBoundsLiteral, GMW_LatLngLiteral, GMW_PolylineOptionsSet, GMW_PolygonOptionsSet, GMW_MarkerOptionsSet, GMW_WrappedPolyline, GMW_WrappedPolygon, GMW_WrappedMarker, GMW_WrappedFeature, MapObjectType, GMW_WrappedGmapObj } from ".";
...
export declare const mapObjectEventCB: (cutting: CuttingState, map_obj: GMW_WrappedGmapObj, event_type: import(".").GMW_PolygonEvents, e: any) => boolean;
export declare const panZoomToObjectOrFeature: (map: google.maps.Map, obj: GMW_WrappedPolygon | GMW_WrappedPolyline | GMW_WrappedMarker | GMW_WrappedFeature, zoom?: boolean) => void;
export {};
