...
declare type setMapObject = (verbose: boolean, map: google.maps.Map, map_objects: MapObjects, cutting: CuttingState, type: MapObjectType, id: string | number, options: AnyObjectOptionsSet, current_options_id?: string) => Promise<GMW_WrappedPolyline | GMW_WrappedPolygon | GMW_WrappedMarker>;
export declare const setMapObject: setMapObject;
export declare const unsetMapObject: (verbose: boolean, map_objects: MapObjects, cutting: CuttingState, type: MapObjectType, id: string | number) => Promise<boolean>;
