...
import { GMW_LatLngLiteral, GMW_MarkerOptionsSet, GMW_WrappedMarker, GMW_DrawingCB } from ".";
...
export declare const setDrawingMode: (services: Services, type: "polyline" | "polygon", opts: google.maps.PolylineOptions | google.maps.PolygonOptions, cb: GMW_DrawingCB, cancel_drawing: boolean, setDrawingCompletedListener: (listener: google.maps.MapsEventListener) => void, drawing_completed_listener?: google.maps.MapsEventListener | undefined) => void;
